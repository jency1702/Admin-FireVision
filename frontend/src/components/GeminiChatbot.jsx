...
//           id: Date.now(),
//           type: 'bot',
//           text: '⚠️ API key not configured. Please set REACT_APP_GEMINI_API_KEY in .env.local'
//         }
//       ]);
//       return;
//     }
...
//       setMessages(prev => [
//         ...prev,
//         { id: Date.now() + 1, type: 'bot', text: botReply }
//       ]);
//     } catch (error) {
...
//           id: Date.now() + 1,
//           type: 'bot',
//           text: '⚠️ Unable to reach Gemini API. Please try again later.'
//         }
//       ]);
//     } finally {
//       setIsLoading(false);
...
//           {!API_KEY && (
//             <div className="bg-red-50 border-t border-red-200 px-4 py-2 text-xs text-red-600">
//               ⚠️ API key not configured. Set <b>REACT_APP_GEMINI_API_KEY</b> in <b>.env.local</b>
//             </div>
//           )}
//         </div>
//       )}
