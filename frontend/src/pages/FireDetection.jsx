...
// import { createFireEvent } from '../services/api';
...
//     try {
//       // Simulate CNN prediction (replace with actual API call to Python backend)
//       // For now, we'll create a mock prediction
//       await new Promise(resolve => setTimeout(resolve, 2000));
      
//       const mlResult = await predictFireCNN(imagePreview);

//       const isFire = mockPrediction.fireProbability > 0.5;
      
//       setResult({
//         label: isFire ? 'Fire' : 'No Fire',
//         ...mockPrediction
//       });
...
//         label: isFire ? 'Fire' : 'No Fire',
//         fireProbability: mockPrediction.fireProbability,
//         dangerScore: isFire ? mockPrediction.dangerScore : null,
//         cause: isFire ? mockPrediction.cause : null,
//         confidence: isFire ? mockPrediction.confidence : null,
//         imageBase64: imagePreview
//       };

//       await createFireEvent(eventData);
...
//               <p className="text-gray-600">Analyzing image with CNN model...</p>
//             </div>
//           )}
...
import { Upload, Flame, AlertTriangle, Camera, Loader2 } from 'lucide-react';
import { createFireEvent } from '../services/api';
import { predictFireCNN } from '../services/mlApi'; // Import ML API
...
const FireDetection = () => {
  ...
  const predictFire = async () => {
    ...
    try {
      ...
      console.error('Error predicting fire:', error);
      setError(error.message || 'Failed to predict fire. Make sure Python backend is running.');
    } finally {
      setLoading(false);
    }
  };
